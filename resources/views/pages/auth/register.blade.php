...
<head>
    ...
    <title>DigiFarma - Register</title>
...
<body class="bg-gradient-primary">
     ...
     <div class="container d-flex flex-column justify-content-center" style="min-width: 100vh;">
                                    ...
                                    <form action="{{ route('register') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="name" class="form-control form-control-user"
                                                id="inputName" name="name" placeholder="Masukkan nama Anda">
                                        </div>
                                        <div class="form-group">
